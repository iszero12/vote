...
import com.doyoung.vote.server.get.getResults
import com.doyoung.vote.server.post.postVote
import com.doyoung.vote.view.activity.MainActivity
        ...
        rootView.apply {
            ...
            yesButton.setOnClickListener {
                GlobalScope.launch {
                    ...
                    if (id != null) {
                        val result = postVote(context, true, id)
            ...
            noButton.setOnClickListener {
                GlobalScope.launch {
                    ...
                    val context = requireContext()
                    if (id != null) {
                        val result = postVote(context, false, id)
                        val aResult = getResults(context, id)
                        if (aResult != null) {
                            withContext(Dispatchers.Main) {
                                val yesBar = findViewById<ConstraintLayout>(R.id.yes_bar)
